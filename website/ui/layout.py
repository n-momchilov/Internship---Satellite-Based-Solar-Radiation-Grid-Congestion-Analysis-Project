...
<div class="site-bar">
  <div class="site-bar-inner">
    ...
    <nav class="topnav">
      ...
      {_nav_link("Knowledge", "📚 Knowledge", active)}
      {_nav_link("Grid Analysis", "🗺 Grid Analysis", active)}
      {_nav_link("Solar vs Grid", "⚡ Solar vs Grid", active)}
    </nav>
  </div>
</div>
""",
...
<div class="footer-wrap">
  <footer class="site-footer">
    <div class="site-footer-inner">
      <span>&copy; 2026 SIS Project</span>
      ''' + logo_html + '''
